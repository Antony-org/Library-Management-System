...
class UserControllerTest {
    ...
    void testFindUserByIdNotFound() throws Exception {
        ...
        this.mockMvc.perform(get(this.baseUrl + "/users/5").accept(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$.message").value("Could not find a user with Id 5"))
    ...
    void testAddUserSuccess() throws Exception {
        ...
        // Given. Arrange inputs and targets. Define the behavior of Mock object userService.
        given(this.userService.save(Mockito.any(LibraryUser.class))).willReturn(user);
    ...
    void testUpdateUserSuccess() throws Exception {
        ...
        LibraryUser updatedUser = new LibraryUser();
        updatedUser.setId(3);
        ...
        // Given. Arrange inputs and targets. Define the behavior of Mock object userService.
        given(this.userService.update(eq(3), Mockito.any(LibraryUser.class))).willReturn(updatedUser);
    ...
    void testUpdateUserErrorWithNonExistentId() throws Exception {
        // Given. Arrange inputs and targets. Define the behavior of Mock object userService.
        given(this.userService.update(eq(5), Mockito.any(LibraryUser.class))).willThrow(new ObjectNotFoundException("user", 5));
