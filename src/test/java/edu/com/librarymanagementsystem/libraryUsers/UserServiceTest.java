...
class UserServiceTest {
    ...
    void setUp() {
        ...
        LibraryUser u2 = new LibraryUser();
        u2.setId(2);
        u2.setUsername("eric");
        ...
        this.libraryUsers.add(u1);
        this.libraryUsers.add(u2);
        this.libraryUsers.add(u3);
    }
    ...
    void testFindAllSuccess() {
        ...
        given(this.userRepository.findAll()).willReturn(this.libraryUsers);

        // When. Act on the target behavior. Act steps should cover the method to be tested.
        List<LibraryUser> actualUsers = this.userService.findAll();

        // Then. Assert expected outcomes.
        assertThat(actualUsers.size()).isEqualTo(this.libraryUsers.size());
    ...
    void testFindByIdSuccess() {
        ...
        // When. Act on the target behavior. Act steps should cover the method to be tested.
        LibraryUser returnedUser = this.userService.findById(1);
    ...
    void testFindByIdNotFound() {
        ...
        assertThat(thrown)
                ...
                .hasMessage("Could not find a user with Id 1");
    ...
    void testSaveSuccess() {
        ...
        // When
        LibraryUser returnedUser = this.userService.save(newUser);
    ...
    void testUpdateSuccess() {
        // Given
        LibraryUser oldUser = new LibraryUser();
        oldUser.setId(1);
        ...
        LibraryUser update = new LibraryUser();
        ...
        // When
        LibraryUser updatedUser = this.userService.update(1, update);
